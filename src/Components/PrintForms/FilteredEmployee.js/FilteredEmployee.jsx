...
import "./FilteredEmployee.css";

function FilteredEmployee ({enrollDetails, componentref}) {
    return (
        <>
            <div ref={componentref} style={{display: "none"}} className="employeeFilteredListPrint">
            <h1>List of filtered employees</h1>
